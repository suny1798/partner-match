...
import com.yupi.patrentmatch.mapper.UserMapper;
...
import static com.yupi.patrentmatch.contant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public int updateUser(User user, User loginUser) {
        //判断用户权限 仅管理员和用户本身
        if (!Objects.equals(loginUser.getId(), user.getId()) && !isAdmin(loginUser)){
